 ...
 */
class ReloadHitoryBooks constructor(executor: ThreadPoolExecutor, var repository: HistoryBooksRepository, var userRepository: UserRepository) : UseCase<List<HistoryBook>, Void?>(executor) {
