 ...
 */
class SearchBooksNextPage @Inject constructor(executor: ThreadPoolExecutor, var repository: SearchBookRepository) : UseCase<SearchResult, SearchResult>(executor) {
